...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>Job Portal</b></span>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
       ...
       <!--  <li class="treeview">
        ...
        <li class="<?php echo (currentpage() == 'blogs') ? "active" : false;?>">
          <a href="../blogs/">
          <i class="fa-solid fa-blog"></i>  <span>Blogs</span> </a>
        </li>
      </ul>
    </section>
    <!-- /.sidebar -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="#">THE HMS</a>.</strong> All rights
    reserved.
  </footer>
