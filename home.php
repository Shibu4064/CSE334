  ...
  <!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="<?php echo web_root; ?>plugins/home-plugins/img/slides/rsz_113.jpg" alt="" height="600px" />
                <div class="flex-caption">
                    <h3 style="color: d8d8d2;">Innovation</h3>
                       <p>We create the opportunities</p>
                 </div>
              </li>
              <li>
                <img src="<?php echo web_root; ?>plugins/home-plugins/img/slides/2.jpg" alt="" height="600px" />
                <div class="flex-caption">
                    <h3>Specialize</h3>
              ...
              <li>
                <img src="<?php echo web_root; ?>plugins/home-plugins/img/slides/1.jpg" alt="" height="600px" />
                <div class="flex-caption">
                    <h3>Modification</h3>
                  <p>Future brings the modernism</p>
               </div>
              </li>
            </ul>
        </div>
                ...
                <div class="block-heading-two">
                  <h3><span>Testimonials</span></h3>
                    ...
                    <div class="active item">
                      ...
                      <img alt="" src="dist/img/user8-128x128.jpg" class="pull-left">
                      <div class="pull-left">
