<section id="content">
	<section class="section-padding">
		<div class="container">
			<div class="row showcase-section">
				<div class="col-md-6">
					<img src="dist/img/photo2.png" height="250px" width="400px" alt="showcase image">
				</div>
				<div class="col-md-6">
	...
	<div class="container">
					<div class="about">
						...
						<!-- Our Team starts -->
						<!-- Heading -->
						<div class="block-heading-six text-center">
							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member text-center">
										<!-- Image -->
										<img class="img-responsive" src="dist/img/user6-128x128.jpg" alt="">
										<!-- Name -->
										<h4>Johne Doe</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member text-center">
										<!-- Image -->
										<img class="img-responsive" src="dist/img/user7-128x128.jpg" alt="">
										<!-- Name -->
										<h4>Jennifer</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member text-center">
										<!-- Image -->
										<img class="img-responsive" src="dist/img/user8-128x128.jpg" alt="">
										<!-- Name -->
										<h4>Christean</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member text-center">
										<!-- Image -->
										<img class="img-responsive" src="dist/img/user1-128x128.jpg" alt="">
										<!-- Name -->
										<h4>Kerinele rase</h4>
